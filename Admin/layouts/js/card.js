      ...
      var id = $(this).data('id'),
         ...
         if (json.isApproved == 0) {
            if ($('.statusBox').hasClass('btn-success')) {
               $('.statusBox').removeClass('btn-success').addClass('btn-info').html('Waiting');
            } else {
               $('.statusBox').addClass('btn-info').html('Waiting');
            }
         } else {
            if ($('.statusBox').hasClass('btn-info')) {
               $('.statusBox').removeClass('btn-info').addClass('btn-success').html('Published');
            } else {
               $('.statusBox').addClass('btn-success').html('Published');
            }
